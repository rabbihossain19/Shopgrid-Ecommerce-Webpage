                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{asset($product->otherImages[0]->image)}}" id="current" height="500" style="border: 1px solid lightskyblue;"  alt="#">
                                </div>
                                <div class="images">
                                    @foreach($product->otherImages as $otherImages)
                                    <img src="{{asset($otherImages->image)}}" class="img" alt="#" height="70" width="30" style="border: 1px solid lightskyblue;"/>
                                    @endforeach
                                </div>
                            </main>
                        </div>
